...
export const ProjectSection = ({
  ...
  <section className="group">
    ...
    <p className="mt-3 text-[0.8125rem] sm:text-sm tracking-[0.08em] uppercase text-accent font-sans font-medium">
      {tagline}
    </p>
    ...
    {statusLine && (
      <p className="mt-3 text-[0.8125rem] italic text-muted-foreground/70 font-serif">
        {statusLine}
      </p>
    )}
    ...
    <div className="mt-7 sm:mt-8 flex flex-wrap items-baseline gap-x-8 gap-y-3">
      ...
      >
        {primaryLink.label}
        <span className="text-muted-foreground/50 transition-transform duration-300 group-hover:translate-x-0.5">→</span>
      </a>
